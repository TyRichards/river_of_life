...
function bones_scripts_and_styles() {
  if (!is_admin()) {
    ...
    wp_register_script( 'equal-height-js', get_stylesheet_directory_uri() . '/library/js/jquery.equalheights.js', array( 'jquery' ), '', true );
    
    wp_register_script( 'custom-js', get_stylesheet_directory_uri() . '/library/js/custom.js', array( 'jquery' ), '', true );
